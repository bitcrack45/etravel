...
for($i=0;$i<count($data->onwardflights);$i++){
...
<div class="container">
    ...
    <div class="col" style="text-align:center;padding-top:30px"><img src=""></div>
    <div class="col" style="text-align:center;padding-top:30px"><?php echo $data->onwardflights[$i]->origin ; echo "-"; echo $data->onwardflights[$i]->destination ; ?></div>
        <div class="col" style="text-align:center;padding-top:30px"><?php echo $data->onwardflights[$i]->origin ; echo "-"; echo $data->onwardflights[$i]->destination ; ?></div>
